...
import sys
sys.path.append('E:\Project\OOC\LEDs_Data_Processing\Encode_Decode')
# khai báo tham số
...
def grid_division(image, nLED,threshold_read,width,id_camera):
    ...
    dbscan = DBSCAN(eps=round(500*0.1/1.3), min_samples=2)
...
image = cv2.imread('Encode_Decode/led_image/paper/paper_4_LED.png')
