...
img = cv2.imread("C:\\Python\\sample\\venv\\app_proccessing_image\\ban_on_dinh\\1. doc pixel\\LedID-cheo1.jpeg")
...
ret, frame0 = cv2.threshold(frame, 150, 255, cv2.THRESH_BINARY)
...
# 3 loop:
    ...
    for i_loop in range(0, n_loop):
        ...
        print(" mang x:", x)
        MANG[i_loop] = x
        # print(f"mang[{i_loop}]:{MANG[i_loop]}")
