...
image = cv2.imread("C:\\Python\sample\\venv\\ban_on_dinh\\1. doc pixel\\test7.jpeg")
...
if str_[0] == j3:
    ...
    for i2 in range(0, j3):
        ...
        if in3[i2][3] <= min1:
            min1 = in3[i2][3]
            x_bot = in3[i2][0]
    str_outout1[0] = (x_bot+x_top)/2
    str_outout1[1] = min1
    str_outout1[2] = (x_bot+x_top)/2
    str_outout1[3] = max1
...
# color = image[330, 220]
image = cv2.resize(image,(780,550))
cv2.imwrite('anh_RoI_len_contours2.jpg',image)
